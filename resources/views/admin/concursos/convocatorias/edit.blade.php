...
<div class="bg-gray-800 bg-opacity-50 p-6 rounded-lg shadow-lg">
    ...
    <form action="{{ route('admin.concursos.convocatorias.update', $convocatoria) }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="{
            currentTab: 'general',
            progress: 20,
            tabs: {
                general: true,
        ...
        <div x-show="currentTab === 'pagos'" class="space-y-6 animate-fade-in">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" name="costo_pre_registro" id="costo_pre_registro" value="{{ old('costo_pre_registro', $convocatoria->costo_pre_registro) }}" class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-blue-500 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="costo_inscripcion" id="costo_inscripcion" value="{{ old('costo_inscripcion', $convocatoria->costo_inscripcion) }}" class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-blue-500 focus:ring-blue-500">
