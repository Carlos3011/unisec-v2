...
<div class="bg-gradient-to-br from-gray-900 to-black rounded-xl shadow-xl p-8 max-w-4xl mx-auto">
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold text-white">Editar Sección</h1>
    ...
    <form method="POST" action="{{ route('admin.noticias.secciones.update', $seccion) }}" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                ...
                <input type="text" name="titulo" id="titulo" value="{{ old('titulo', $seccion->titulo) }}" required
