...
<div class="container px-6 mx-auto grid">
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
        Gestión de Pagos de Congresos
    </h2>

    <!-- Filtros -->
    <div class="mb-6 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-xs">
        <form action="{{ route('admin.congresos.pagos.index') }}" method="GET" class="flex flex-wrap gap-4">
            ...
            <table class="w-full whitespace-no-wrap">
                <thead>
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                        ...
                        <th class="px-4 py-3">Congreso</th>
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-sm">{{ $pago['congreso'] }}</td>
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex items-center space-x-4">
                                <a href="{{ route('admin.congresos.pagos.show', $pago['id']) }}" class="text-purple-600 hover:text-purple-900 dark:text-purple-400 dark:hover:text-purple-300 transition-colors duration-150">
                                    <i class="fas fa-eye"></i>
                                </a>
                                @if($pago['estado_pago'] === 'pagado')
                                <a href="{{ route('admin.congresos.pagos.factura', $pago['id']) }}" class="text-purple-600 hover:text-purple-900 dark:text-purple-400 dark:hover:text-purple-300 transition-colors duration-150">
    ...
    <!-- Botón Exportar -->
    <div class="mt-6">
        <a href="{{ route('admin.congresos.pagos.exportar') }}" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple inline-flex items-center">
