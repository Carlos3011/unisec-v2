...
<div class="bg-gray-900 text-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Crear Nuevo Taller</h1>
    </div>

    <form action="{{ route('admin.talleres.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                <label for="titulo" class="block text-sm font-medium mb-2">Título del Taller</label>
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('admin.talleres.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                Cancelar
            </a>
