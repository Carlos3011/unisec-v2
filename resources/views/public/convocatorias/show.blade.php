...
<div class="min-h-screen  py-12 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto bg-black/40 backdrop-blur-2xl rounded-3xl shadow-[0_0_50px_rgba(0,149,255,0.15)] overflow-hidden border border-white/20 relative">
            ...
            <div class="relative overflow-hidden mb-8">
                ...
                <div class="relative z-20 p-8">
                    <h1 class="text-4xl font-bold text-white mb-4 drop-shadow-lg">{{ $convocatoria->nombre_evento }}</h1>
                    <div class="flex flex-wrap gap-6 text-sm text-white/90">
                        ...
                        <div class="flex items-center space-x-2">
                            <i class="fas fa-users-gear text-blue-400"></i>
                            <span>Máximo {{ $convocatoria->max_integrantes }} integrantes</span>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-8 relative">
                ...
                <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 hover:shadow-[0_0_30px_rgba(0,149,255,0.2)] transition-all duration-300 transform hover:-translate-y-1">
                ...
                <!-- Fechas Importantes -->
                <div class="bg-white/5 backdrop-blur rounded-xl p-6 border border-white/10 hover:border-blue-500/50 transition-all duration-300">
                    <h2 class="text-xl font-semibold text-white mb-4 flex items-center">
                ...
                <div class="bg-white/5 backdrop-blur rounded-xl p-6 border border-white/10 hover:border-blue-500/50 transition-all duration-300">
                    <h2 class="text-xl font-semibold text-white mb-4 flex items-center">
                        <i class="fas fa-satellite-dish text-blue-400 mr-2"></i>Contacto
                    </h2>
                    @if($convocatoria->contacto_email)
                        <div class="flex items-center text-white/90">
                            <i class="fas fa-envelope mr-2 text-blue-400"></i>
                            <a href="mailto:{{ $convocatoria->contacto_email }}" class="text-blue-400 hover:text-blue-300 transition-colors duration-200">
            ...
            <div class="space-y-6 p-8">
                <!-- Dirigido a -->
                <div class="bg-white/10 backdrop-blur-2xl rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 hover:shadow-[0_0_30px_rgba(0,149,255,0.2)] transition-all duration-300 transform hover:-translate-y-1">
                    <h2 class="text-xl font-semibold text-white mb-4 flex items-center">
                ...
                <!-- Requisitos -->
                <div class="bg-black/40 backdrop-blur-2xl rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 hover:shadow-[0_0_30px_rgba(0,149,255,0.2)] transition-all duration-300 transform hover:-translate-y-1">
                    <h2 class="text-xl font-semibold text-white mb-4 flex items-center">
                        <i class="fas fa-clipboard-list text-blue-400 mr-2"></i>Requisitos
                    </h2>
                ...
                <div class="bg-black/40 backdrop-blur-2xl rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 hover:shadow-[0_0_30px_rgba(0,149,255,0.2)] transition-all duration-300 transform hover:-translate-y-1">
                    <h2 class="text-xl font-semibold text-white mb-4 flex items-center">
                        <i class="fas fa-vial text-blue-400 mr-2"></i>Pruebas Requeridas
                    </h2>
                    <div class="prose max-w-none text-white/80">
                ...
                <div class="bg-black/40 backdrop-blur-2xl rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 hover:shadow-[0_0_30px_rgba(0,149,255,0.2)] transition-all duration-300 transform hover:-translate-y-1">
                    <h2 class="text-xl font-semibold text-white mb-4 flex items-center">
                        <i class="fas fa-star-half-alt text-blue-400 mr-2"></i>Criterios de Evaluación
                    </h2>
                    <div class="prose max-w-none text-white/80">
                ...
                @if($convocatoria->penalizaciones)
                    ...
                    <div class="bg-black/40 backdrop-blur-2xl rounded-2xl p-6 border border-white/20 hover:border-blue-400/50 hover:shadow-[0_0_30px_rgba(0,149,255,0.2)] transition-all duration-300 transform hover:-translate-y-1">
                        <h2 class="text-xl font-semibold text-white mb-4 flex items-center">
                            <i class="fas fa-exclamation-triangle text-blue-400 mr-2"></i>Penalizaciones
                        </h2>
                        <div class="prose max-w-none text-white/80">
            ...
            <div class="mt-8 text-center p-8">
                <a href="{{ route('convocatorias') }}" 
                   class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-500 transition-colors duration-200 group">
...
<div class="fixed bottom-8 right-8 z-50">
    <a href="#" class="group relative inline-flex items-center px-8 py-4 bg-blue-600/30 backdrop-blur-xl text-white rounded-full overflow-hidden border border-white/20 hover:bg-blue-500/40 hover:border-blue-400/50 hover:shadow-[0_0_30px_rgba(0,149,255,0.3)] transition-all duration-300 animate-pulse-slow">
        <div class="absolute inset-0 bg-gradient-to-r from-blue-600/20 via-purple-500/20 to-blue-600/20 animate-shimmer"></div>
        <i class="fas fa-rocket mr-3 transform group-hover:rotate-12 transition-transform duration-300"></i>
        <span class="font-semibold tracking-wide">Inscribirse a la Misión</span>
    </a>
</div>
