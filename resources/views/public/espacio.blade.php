...
@section('titulo', 'Exploración Espacial')

@section('contenido')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Sección de introducción -->
    <div class="text-center mb-8 animate-fade-in transform hover:scale-102 transition-all duration-500">
        <h1 class="text-5xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent mb-6 animate-gradient">Exploración Espacial Interactiva</h1>
        <p class="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed backdrop-blur-sm bg-space-900/10 p-6 rounded-xl border border-white/5 hover:border-white/10 transition-all duration-500">Embárcate en un viaje fascinante a través de nuestro sistema solar. Descubre los secretos del cosmos, explora planetas misteriosos y maravíllate con la grandeza del universo en esta experiencia inmersiva proporcionada por NASA Eyes.</p>
    </div>
...
<!-- Sección de Invitación al Registro -->
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-xl p-8 text-center border border-blue-500/20 backdrop-blur-sm hover:border-blue-400/40 transition-all duration-500">
        <div class="max-w-3xl mx-auto space-y-6">
            <i class="fas fa-user-astronaut text-purple-500 text-5xl mb-4"></i>
            <h2 class="text-3xl font-bold text-white">¿Listo para explorar más allá?</h2>
            <p class="text-xl text-gray-300">Regístrate ahora y descubre todos los planetas de nuestro sistema solar en detalle. Obtén acceso exclusivo a características adicionales y contenido especial.</p>
            <div class="flex flex-col sm:flex-row justify-center gap-6 mt-8">
                <a href="{{ route('register') }}" class="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 text-white rounded-xl transition-all duration-500 transform hover:scale-102 hover:shadow-[0_8px_25px_rgba(147,51,234,0.35)] backdrop-blur-sm">
                    <i class="fas fa-rocket mr-3 group-hover:animate-pulse"></i>
                    <span class="font-medium">Registrarse</span>
                </a>
                <a href="{{ route('login') }}" class="group inline-flex items-center px-8 py-4 bg-transparent border-2 border-purple-400/30 text-purple-400 hover:border-purple-400/50 hover:bg-purple-400/10 rounded-xl transition-all duration-500 backdrop-blur-sm hover:shadow-[0_8px_25px_rgba(147,51,234,0.15)]">
