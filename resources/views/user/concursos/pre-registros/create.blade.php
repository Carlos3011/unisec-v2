        ...
        <form action="{{ route('user.concursos.pre-registros.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-between">
                <a href="{{ route('user.concursos.pre-registros.index') }}"
                    class="mr-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Cancelar
                </a>
                <button type="submit"
                    class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                    Crear Pre-registro
                </button>
            </div>
        </form>
